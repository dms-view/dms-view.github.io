...
// domain.
svg.append("defs").append("clipPath").attr("id", "clip").append("rect").attr("width", plot_dx).attr("height", plot_dy);
...
d3.csv("_data/line-data-PGT151.csv").then(function (d) {
  ...
  focus.append("path").datum(d).attr("class", "line").style("clip-path", "url(#clip)").attr("d", valueline);
